...
# This line adds the 'current_year' variable into the app
...
def authorised_only(f):
    ...
    def decorated_function(*args, **kwargs):
        if not current_user.is_authenticated or current_user.id not in allowed_users:
            return abort(403)
...
def admin_only(f):
    ...
    def decorated_function(*args, **kwargs):
        ...
        # this will not work in case I am not logged in
...
def show_post(post_id):
    ...
    return render_template("post.html", post=requested_post, form=form, current_user=current_user, comments=False)
...
def comment_post(post_id):
    ...
    return render_template("post.html", post=requested_post, form=form, current_user=current_user, comments=True)
...
def add_new_post():
    ...
    if form.validate_on_submit():
        new_post = BlogPost(
            ...
            author=current_user,
            # author=form.author.data,  # in the final project the author attribute won't be needed
